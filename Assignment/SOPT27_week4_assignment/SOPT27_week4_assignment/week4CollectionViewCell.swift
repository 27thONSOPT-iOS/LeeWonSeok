...
class week4CollectionViewCell: UICollectionViewCell {
    
    static let identifier = "week4CollectionViewCell"
    ...
    static func nib() -> UINib {
        return UINib(nibName: "week4CollectionViewCell", bundle: nil)
    }
